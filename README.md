...
**Tracking a branching chatroom horror visual novel.**
...
Killer Chat! - Expanded Edition is a dark satirical visual novel and dating simulation set inside a serial killer chatroom. The player controls a customizable writer gathering material for a crime book while navigating branching conversations, relationships, and multiple endings. The game is currently in development, with this repository tracking pre-alpha progress and iteration.

This devlog is for visual novel fans, narrative game developers, and readers interested in branching romance horror.
...
- 💬 **Chatroom Fiction** — Story progression centers on conversations with members of a serial killer server.
- 🫀 **Branching Relationships** — Choices shape friendships, romances, routes, and possible endings.
- 🧩 **Customizable Protagonist** — The player can define the writer's identity, personality, appearance, and background.
- 🖥️ **Desktop Activities** — The expanded structure includes writing, browsing, room decoration, minigames, and appearance changes.
- 🎙️ **Voiced Calls** — Video and voice calls are part of the expanded story presentation.

## 📸 Screenshots

<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3378100/a7ea828d01451a7cbc771659be8fd1cd777eaaaa/ss_a7ea828d01451a7cbc771659be8fd1cd777eaaaa.1920x1080.jpg?t=1788108389" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3378100/7b7acdf003f6bc5c5515a078e078874568915147/ss_7b7acdf003f6bc5c5515a078e078874568915147.1920x1080.jpg?t=1788108389" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/3378100/ss_7b2a4b30cb006e9dbdbb508ec0390efcc5c14982.1920x1080.jpg?t=1788108389" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
|:--- |:--- |:--- |
| **OS** | Windows 7 or higher (64-bit) | Windows 10 or higher (64-bit) |
| **Processor** | 64-bit Intel-compatible processor | Intel Core i3-6100 or equivalent |
| **RAM** | 300 MB | 4 GB |
| **Graphics** | OpenGL 3.0-compatible graphics | NVIDIA GeForce GTX 750 or equivalent |
| **Storage** | 1 GB available space | 1 GB available space |
| **Additional** | OpenGL 3.0 | Updated graphics drivers |
